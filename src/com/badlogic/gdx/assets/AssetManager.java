...
public class AssetManager implements Disposable
{
	...
	public void loadFromCrawler(String path, Class<?> type)
	{
		load(ResourceCrawler.getResource(path), type);
	}
	
	public synchronized <T> T getCrawled(String fileName, Class<T> type)
	{
		return get(ResourceCrawler.getResource(fileName), type);
	}
}
