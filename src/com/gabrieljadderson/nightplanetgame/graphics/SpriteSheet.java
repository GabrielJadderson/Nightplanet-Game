...
public class SpriteSheet implements Disposable
{
	...
	public static TextureRegion loadPNG_tex_reg(FileHandle file)
	{
		Texture TEX = new Texture(file);
		return new TextureRegion(TEX);
	}
	
	public static Texture loadPNG_tex(FileHandle file)
	{
	 ...
	 *
	 * @param row    Horizontal position of the sprite.
	 * @param column Vertical position of the sprite.
	 */
	 ...
	 * @param row    Horizontal position of the sprite.
	 * @param column Vertical position of the sprite.
	 * @param mirror True to get horizontally flipped sprite image.
	 */
