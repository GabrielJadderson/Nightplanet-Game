...
public class Illumination2D implements ApplicationListener
{
	...
	public void create()
	{
		...
		// load our textures
		teapot = new Texture(ResourceCrawler.getRes("teapot.png"));
		teapot_n = new Texture(ResourceCrawler.getRes("teapot_n.png"));
//		rock = new Texture(Gdx.files.internal("C:/Users/mulli/Dropbox/Development/Java Projects/NightPlanetGame-master/core/assets/objects/test/rock.png"));
		rock = new Texture(ResourceCrawler.getRes("heart_med.png"));
//		rock_n = new Texture(Gdx.files.internal("C:/Users/mulli/Dropbox/Development/Java Projects/NightPlanetGame-master/core/assets/objects/test/rock_n.png"));
		rock_n = new Texture(ResourceCrawler.getRes("heart_med_n.png"));
...
//		System.out.println("FRAGMENT PROGRAM:\n------------\n\n"+frag);
	...
	public void render()
	{
		...
		String str = MessageFormat.format(TEXT, ambientIntensity, attenuation.x, attenuation.y, DEC_FMT.format(attenuation.z), strength, lightPos.z);
