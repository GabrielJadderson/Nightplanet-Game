...
public class NormalMapTest extends ApplicationAdapter
{
	...
	{
		this.skeletonPath = "spineboy-old";
	...
	class UI
	{
		...
		Skin skin = new Skin(ResourceCrawler.getRes("skin.json"));
		Preferences prefs = Gdx.app.getPreferences(".com.gabrieljadderson.nightplanetgame.spine/NormalMapTest");
	...
	{
		new LwjglApplication(new NormalMapTest());
	}
}