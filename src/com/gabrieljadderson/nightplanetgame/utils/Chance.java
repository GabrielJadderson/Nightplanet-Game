...
public enum Chance
{
	 ...
	 *
	 * @param tier        the tier level of "rareness".
	 * @param numerator   the numerator of this chance.
	 * @param denominator the denominator of this chance.
	 */
	 ...
	 *
	 * @param random the random number generator used to determine this.
	 ...
	 * recommended).
	 *
	 * @param results the amount of times to debug this chance.
	 */
